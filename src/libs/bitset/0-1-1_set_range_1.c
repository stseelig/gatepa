...
/** @fn bitset_set_range_1
  * @brief sets the bits from first to last to 1
  *
...
/*@modifies	*bitset@*/
{
	...
	memset(&bitset[first_idx_byte + 1u], 0xFF, set_len);
